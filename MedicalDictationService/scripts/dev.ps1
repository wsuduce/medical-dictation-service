...
Write-Host "   Alt User: test@test.com / Test123!" -ForegroundColor White
Write-Host ""
Write-Host "ℹ️  Development Mode:" -ForegroundColor Cyan
Write-Host "   • HTTPS redirection disabled" -ForegroundColor White
Write-Host "   • Using HTTP only for development" -ForegroundColor White
Write-Host "   • All authentication features enabled" -ForegroundColor White
Write-Host ""
...
# Start the application with HTTP profile
Write-Host "Starting with HTTP profile - no HTTPS redirect warnings..." -ForegroundColor Green
